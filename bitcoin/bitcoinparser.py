...
print("Parsing from block: " + str(blocks_stored_count) + " to " + str(current_blockchain_length()))
#Loops through bitcoin_blockchain extracting block & transaction info
for blocks_stored_count in range(blocks_stored_count, current_blockchain_length()):
